...
public class PTra13_04 {
	...
	public static void main(String[] args) {
		 ...
		 * 上記を繰り返し行います
		 */
		//while((slime.damage(hero.attack()) == (hero.damage(slime.attack())))){

			//slime.damage(hero.attack());
			//System.out.println(hero.attack());

			//System.out.println(hero.damage(slime.attack()));

			//break;

		//while (hero.damage(slime.attack()) || slime.damage(hero.attack()))
		//for (int i = 0 ; i< 2; i++ ) {
